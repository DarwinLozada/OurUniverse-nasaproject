...
export default function ThirdTutorialSection({ setTutorialSection }) {
  return (
    <div>
      <h2 className="text-3xl images-opaque-shadow text-purple-100 text-center">
        Look at the images more carefully
      </h2>
      <p className="text-purple-200 text-2xl mt-6 text-center images-opaque-shadow">
      ...
      <div className="relative mt-16 images-opaque-shadow">
        ...
        />
        <CursorIcon classNames="absolute text-white transform -rotate-90 -bottom-12 right-0 w-20" />
      </div>
      <button
